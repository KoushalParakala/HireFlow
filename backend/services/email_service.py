...
<body style="font-family: 'Inter', Arial, sans-serif; background: #f9f9ff; padding: 40px 20px; color: #151c27;">
  <div style="background: #ffffff; border-radius: 24px; padding: 40px; max-width: 560px; margin: auto; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.04); border: 1px solid #dce2f3; text-align: center;">
    ...
    <a href="{web_link}" style="display: inline-block; padding: 16px 32px; background: #fc8a40; color: #672c00; border-radius: 16px; text-decoration: none; font-weight: 600; font-size: 16px; box-shadow: 0 4px 20px rgba(252, 138, 64, 0.3);">Start in Web Browser</a>
    <br>
    <a href="{deep_link}" style="display: inline-block; margin-top: 24px; color: #000000; text-decoration: underline; font-weight: 500;">Open in Mobile App</a>
    <br>
    <a href="{apk_link}" style="display: inline-block; margin-top: 12px; font-size: 14px; color: #45474a; text-decoration: underline; font-weight: 500;">Download Mobile App (.apk)</a>
